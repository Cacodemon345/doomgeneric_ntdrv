...
// ?
//
void __cdecl A_Light0 (player_t *player, pspdef_t *psp)
{
    player->extralight = 0;
}

void __cdecl A_Light1 (player_t *player, pspdef_t *psp)
{
    player->extralight = 1;
}

void __cdecl A_Light2 (player_t *player, pspdef_t *psp)
{
    player->extralight = 2;
}
...
//
void __cdecl A_BFGSpray (mobj_t* mo) 
{
    int			i;
    int			j;
    int			damage;
